#!/bin/env python3
#coding=utf-8
# @Time    : 2018/6/7 上午12:19
# @Author  : kelly
# @Site    : 
# @File    : d_mile_analyze.py
# @Software: PyCharm
import datetime
...
class deal_data():
    ...
    def get_noise_data(self,data):
        ...
        while index < len(aa_data):
            ...
            if (aa_data[index][2] == mile and datedelta == aa_data[index][1]):
    ...
    def all_carriage_noise_deal(self,data=None):
        ...
        for carriage in carriages:
            ...
            try:
                ...
                self.reserve_train_data(carriage[0])
                # deal noise_data_set
...
# raise
# # @比较
deal_data().all_carriage_noise_deal('0251')
